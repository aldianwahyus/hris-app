...
<div class="kepala">
  ...
  <p>Top 20 pegawai berdasarkan total poin pelatihan</p>
</div>

<div class="gulir">
  <table>
    <thead>
      <tr><th>#</th><th>Pegawai</th><th>Total Poin</th></tr>
    </thead>
    <tbody>
      @forelse ($rows as $i => $r)
        <tr>
      ...
      @empty
        <tr><td colspan="3" class="kosong">Belum ada poin tercatat.</td></tr>
      @endforelse
    </tbody>
  </table>
</div>
