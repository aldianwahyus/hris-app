...
/**
 * Layanan Dokumen Mandiri — ESS, lingkup SELF murni (pola sama
 * IzinRequestController). SATU tahap: HC langsung terbitkan/tolak,
 * tidak ada Application layer terpisah (murni CRUD administratif,
 * tidak ada aturan bisnis kompleks yang perlu dipisah — pola sama
 * EmployeeFamilyMemberController).
 */
final class DocumentRequestController extends Controller
{
    ...
    {
        return view('documents.create', ['documentTypes' => self::DOCUMENT_TYPES]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('documents.history')->with('sukses', 'Permintaan dokumen terkirim, menunggu diproses HC.');
    }
    ...
    public function history(Request $request): View
    {
        ...
        return view('documents.history', ['requests' => $requests, 'documentTypes' => self::DOCUMENT_TYPES]);
    }

    /** Unduh dokumen yang sudah 'siap' — lingkup SELF (HC memakai jalur terpisah, lihat DocumentRequestQueueController). */
    ...
    /** @param  object{id: string, employee_id: string, document_type: string, purpose: string, processed_at: ?string}  $row */
    private function renderPdf(object $row): Response
    {
